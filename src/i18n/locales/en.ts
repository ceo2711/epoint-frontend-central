...
export const en: Messages = {
  ...
  login: {
    ...
    forgotPasswordHint: "We will send the link to the email you enter",
  ...
  forgotPassword: {
    ...
    subtitle: "Enter the email address where we should send the password reset link.",
    emailLabel: "Email address",
    emailPlaceholder: "name@company.com",
    emailHelp: "We will send the password reset link to this email.",
    submit: "Send link",
    submitting: "Sending...",
    success:
      "If that email is linked to an account, you will receive a link to reset your password. If it does not arrive, check spam.",
    error: "Could not process the request",
    backToLogin: "Back to sign in",
  },
  resetPassword: {
    title: "New password",
    subtitle: "Enter your new password and repeat it to confirm.",
    newPassword: "New password",
    newPasswordHelp: "At least 8 characters.",
    confirmPassword: "Repeat your new password",
    confirmPasswordHelp: "It must match the new password.",
  ...
  sensitiveDocs: {
    ...
    ssnSubtitle: "Enter your two-factor code to view the Social Security Number.",
  ...
  docusign: {
    ...
    uploadManualAction: "Upload signed contract",
    uploadManualTitle: "Upload physical contract",
    uploadManualSubtitle:
      "If the prospect signed on paper, upload the PDF or a photo. It will be marked as signed, same as DocuSign.",
    uploadManualHint: "PDF, JPG, PNG, or WebP. Max 20 MB.",
    uploadManualSubject: "Subject (optional)",
    uploadManualSubjectPlaceholder: "Signed physical contract",
    uploadManualFile: "File",
    uploadManualSubmitting: "Uploading...",
    uploadManualSuccessTitle: "Contract uploaded",
    uploadManualSuccessMessage: "The contract was marked as signed.",
    uploadManualError: "Could not upload the contract",
    uploadManualFileRequired: "Choose a file to continue.",
    originManual: "Physical contract",
    ...
    clientContractsSubtitle: "DocuSign contracts and uploaded physical contracts for this client.",
  ...
  payments: {
    ...
    remainderDue: {
      editTitle: "Change remaining-balance date",
      editSubtitle: "Update the date agreed for the prospect to complete the payment.",
      save: "Save date",
      change: "Change date",
      success: "Remaining-balance date updated.",
      error: "Could not update the remaining-balance date",
    },
    status: {
      pending: "Pending",
      partial: "Partial",
  ...
  prospects: {
    ...
    qualificationHint: "Optional. You can set it now or later. Kept when converting to a client.",
    qualificationLater: "Set later",
    qualificationPending: "Not qualified yet",
  ...
  clientDetail: {
    ...
    hideSsn: "Hide SSN",
    copySsn: "Copy SSN",
    ssnLoadError: "Could not load the SSN. Try again.",
    ...
    vehicleOptionalHint: "Vehicle data is optional. You can add it now or later.",
    saveVehicle: "Save vehicle",
    vehicleSaved: "Vehicle saved",
    vehicleSaveError: "Could not save the vehicle.",
  ...
  portal: {
    ...
    step1Desc: "SSN, address, vehicle (optional)",
  ...
  portalData: {
    ...
    subtitle: "Information for your onboarding. Vehicle data is optional.",
    ...
    help: {
      ...
      vehicle: "Optional. We use it to identify your car on credit and funding applications.",
  ...
  portalBoard: {
    ...
    commentUpdateError: "Could not update the comment.",
    deleteComment: "Delete comment",
    deleteCommentConfirm: "Delete this comment? This action cannot be undone.",
    deleteCommentError: "Could not delete the comment.",
    addColumn: "New column",
    columnTitleLabel: "Column name",
    ...
    deleteColumnConfirmOne:
      "The column “{title}” has 1 card. If you delete it, that card is lost permanently.\n\nTo keep it, move it to another column first, then delete this one.",
    deleteColumnConfirmMany:
      "The column “{title}” has {count} cards. If you delete it, those cards are lost permanently.\n\nTo keep them, move them to another column first, then delete this one.",
    deleteColumnError: "Could not delete the column.",
    createColumnError: "Could not create the column.",
    columns: {
      clientToDo: "Client TO DO",
      credentials: "Credentials",
      ideas: "Ideas to complete",
      experian: "Experian",
      equifax: "Equifax",
      transunion: "TransUnion",
      personalFunding: "Personal Funding Sequence",
      businessFunding: "Business Funding Sequence",
      completed: "Completed",
    },
    editCardTitle: "Edit card name",
    saveCardTitle: "Save name",
    editCardTitleError: "Could not rename the card.",
