...
export const en: Messages = {
  ...
  nav: {
    ...
    boardLocked: "Complete your data and documents to unlock the board",
    account: "My account",
  ...
  portal: {
    ...
    lock: {
      credit: "Credit advisory unlocks when you hire that service with a sales rep.",
      course: "The video program unlocks when you purchase the course.",
      mentorship: "1:1 mentorship unlocks when you book live sessions.",
    },
  },
  courses: {
    watchSubtitle: "12 modules to understand the credit system",
    manageSubtitle: "Upload one MP4 per lesson. Clients watch it in the portal.",
    loading: "Loading course...",
    loadError: "Could not load the course",
    empty: "There is no published course yet",
    module: "Module",
    pickLesson: "Pick a lesson to play it",
    comingSoon: "This lesson has no video yet",
    noVideo: "no video",
    completed: "watched",
    progress: "{done} of {total} lessons watched",
    videosReady: "{ready} of {total} lessons with video",
    uploadMp4: "Upload MP4",
    uploading: "Uploading...",
    removeVideo: "Remove video",
    uploadError: "Could not upload the video",
    uploadCors: "Storage rejected the direct upload. Check the bucket CORS.",
    playError: "Could not open the video",
  },
  portalBoardUnlock: {
    title: "Congratulations!",
