...
export function LoginHero() {
  ...
  return (
    <div className="relative z-10 hidden flex-col justify-between p-12 text-white lg:flex lg:w-1/2 xl:p-16">
      <div className="relative z-10">
        <div className="flex items-center gap-5">
          ...
          <div className="min-w-0">
            <p className="text-3xl font-bold tracking-tight text-white xl:text-4xl">Epoint Corporation</p>
          </div>
        </div>
      </div>
      ...
      <p className="relative z-10 text-xs text-cream-700">© 2026 Epoint Corporation</p>
    </div>
  );
}
