...
export const en: Messages = {
  ...
  dashboard: {
    ...
    monthlyCommissionHint:
      "Based on {count} prospect payment(s). Provisional {rate}% commission on collected amount.",
